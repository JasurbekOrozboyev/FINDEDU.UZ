            ...
            <div className="bg-white rounded-lg shadow-lg max-w-4xl w-full flex gap-6 p-6">
                ...
                <ul>
                  <li
                    className={`cursor-pointer py-2 px-3 rounded-md mb-1 ${
                      selectedRegion === null ? "bg-[#1976D5] text-white" : "hover:bg-gray-100"
                    }`}
                  ...
                  {regions.map((region) => (
                    <li
                      key={region.id}
                      className={`cursor-pointer py-2 px-3 rounded-md mb-1 ${
                        selectedRegion === region.id ? "bg-[#1976D5] text-white" : "hover:bg-gray-100"
                      }`}
              ...
              <div className="flex-1 max-h-[400px] overflow-y-auto pl-4">
                ...
                <ul>
                  <li
                    className={`cursor-pointer py-2 px-3 rounded-md mb-1 ${
                      selectedMajor === null ? "bg-[#1976D5] text-white" : "hover:bg-gray-100"
                    }`}
                  ...
                  {majors.map((major) => (
                    <li
                      key={major.id}
                      className={`cursor-pointer py-2 px-3 rounded-md mb-1 ${
                        selectedMajor === major.id ? "bg-[#1976D5] text-white" : "hover:bg-gray-100"
                      }`}
